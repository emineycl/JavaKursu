...
public class C06_ArrayiTekrarsizYapma {
    ...
    public static int[] benzersizYap(int[] arr) {
        ...
        int[] benzesizArr=new int[benzersizList.size()];

        //bir loop ile listedeki elemetleri array'r atayalim

        for (int i = 0; i <benzesizArr.length ; i++) {

            benzesizArr[i]=benzersizList.get(i);
        }
