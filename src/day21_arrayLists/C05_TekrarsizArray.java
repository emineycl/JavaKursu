...
public class C05_TekrarsizArray {
    public static void main(String[] args) {
        ...
        int[] benzersizArr=new int[benzersizList.size()];    //size , list'in uzunlugunu verir*

        //benzersiz listenin uzunnlugunda bir array olusturduk
        ...
        System.out.println("arr'in son hali : " + Arrays.toString(arr));   //arr'in son hali : [1, 2, 3, 4]
    }
}
