...
public class CKumesKuslari extends BKuslar{
    ...
    public static void main(String[] args) {
     ...
     //   System.out.println(kk2.yasamYeri);  ///CET
        ...
        kk2.gaga();     //B Kuslar akcigerle nefes alirlar
