...
public class C01 {
    ...
    /*
    Java ile projeler olustururken her class'da main method olmasina gerek yoktur.
    Hatta bir projede class'larin buyuk cogunlugunda main method olmaz

    icinde main method olmayan class'lari objeler olusturmak icin veya fayadali method'lari koyup
