...
public class C05_MethodOlusturma {
    public static void main(String[] args) {
        ...
        System.out.println(carpim(2.3,3.4));  //7,819999999

        //uc sayinin carpimini yazdiralim

        System.out.println(carpim(2.3,4.5,5.6));  //57,9599999994
        ...
        System.out.println(carpim(2,3,4,5));   //120.0
         ...
         /*
          ...
          bunun icin ya farkli sayida parametre kullanilmali
